...
<!-- Mirrored from elmanawy.info/demo/ariel/ltr/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Jan 2021 12:56:04 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Light Case -->
    <link rel="stylesheet" href="frontend/css/lightcase.min.css" type="text/css">
    <!-- Template style -->
                ...
                <div class="col-md-6 start-home-content">
                    ...
                    <div class="description-block">
                        <form class="contact-form">
                            <input type="text" id="nama" class="form-control" placeholder="Nama Karyawan" disabled/>
                            <input type="email" id="jabatan" class="form-control" placeholder="Jabatan" disabled/>
                            <input type="tel" id="divisi" class="form-control" placeholder="Divisi" disabled/>
                        </form>
                    </div>
                </div>
                <div class="col-md-6 start-home-img">
                    <img class="img-fluid" src="frontend/images/banner-home-2.svg" alt="Img"/>
                </div>
            </div>
        </div>
    </div>
...
<!-- Images LightCase -->
<script src="frontend/js/lightcase.min.js"></script>
<!-- scrollIt -->
...
<script>'undefined' === typeof _trfq || (window._trfq = []);
    'undefined' === typeof _trfd && (window._trfd = []), _trfd.push({'tccl.baseHost': 'secureserver.net'}), _trfd.push({'ap': 'cpsh'}, {'server': 'p3plcpnl0763'}) // Monitoring performance to make your website faster. If you want to opt-out, please contact web hosting support.</script>
            ...
            success: function (res) {
                if (res.code == 200) {
                    ...
                    if (res.status==3){
                        ...
                        $('#nama').val(res.data.employee_name)
                        icon="success"
                    }
